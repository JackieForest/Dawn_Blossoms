...
def build_output(
    ...
    out.update(
        {
            "selection_method": "9b_normalized_answer_likelihood",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Select best 9B correct rollout by normalized answer likelihood.")
