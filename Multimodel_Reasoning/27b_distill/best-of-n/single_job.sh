...
EXP_NAME="${NAME:-qwen35_27b_best_of_n}"
...
RESERVED_MARKER="${RESERVED_MARKER_DIR}/${SHARD_ID}.marker"
...
while true; do
    ...
    echo "[${EXP_NAME}] submitting shard ${SHARD_ID}: partition=${PARTITION} quota=${QUOTA_TO_USE} gpus=${GPUS}"
