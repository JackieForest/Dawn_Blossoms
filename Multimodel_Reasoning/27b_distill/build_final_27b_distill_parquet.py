...
DEFAULT_FINAL_ROLLOUTS_DIR = Path(
    "/mnt/dhwfile/raise/user/linjuekai/Multimodel_Reasoning/rollouts/output/"
    "distill_results/27b_distill/final_rollouts"
)
DEFAULT_OUTPUT_DIR = DEFAULT_FINAL_SPLITS_DIR / "final"
DEFAULT_OUTPUT_NAME = "Final_qwen35_27b_distill-131k.parquet"
DEFAULT_LOG_FILE = Path(
    "/mnt/dhwfile/raise/user/linjuekai/Multimodel_Reasoning/rollouts/output/"
    "distill_results/27b_distill/build_final_27b_distill_parquet.log"
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Build one final 27B distill parquet by adding the selected best rollout response "
