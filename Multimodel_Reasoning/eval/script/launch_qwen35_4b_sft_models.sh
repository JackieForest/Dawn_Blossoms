#!/bin/bash
# Launch eval for four Qwen3.5-4B SFT models using the SFT prompt.
...
echo "Submitted four SFT eval jobs. Check with:"
echo "  squeue -u linjuekai"
echo "Launcher logs: ${PROJECT_DIR}/launcher_logs/qwen35_4b_base_*_sft_*_16k.log"
echo "EVAL_ENABLE_THINKING=${EVAL_ENABLE_THINKING}"
echo "EVAL_SYSTEM_PROMPT_MODE=${EVAL_SYSTEM_PROMPT_MODE}"
echo "Rollout outputs: /mnt/dhwfile/raise/user/linjuekai/Multimodel_Reasoning/eval/outputs/qwen35_4b_base_*_16k"
