#!/bin/bash
# Roll out spatial/general RL QwenJudge step220 on spatial/general benchmarks.
set -euo pipefail

PROJECT_DIR=/mnt/petrelfs/linjuekai/Multimodel_Reasoning/eval
MODEL_PATH=/mnt/dhwfile/raise/user/linjuekai/Multimodel_Reasoning/training/rl/qwen35_4b_full_sft_spatial_general_gspo_qwen_judge/global_step_220/actor/huggingface
BASE_ALIAS=qwen35_4b_spatial_general_qwenjudge_step220
...
echo "Submitted spatial/general step220 per-benchmark rollout jobs."
