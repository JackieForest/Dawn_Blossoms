#!/bin/bash
# Roll out spatial/general RL step100 with SFT metadata restored.
set -euo pipefail

PROJECT_DIR=/mnt/petrelfs/linjuekai/Multimodel_Reasoning/eval
MODEL_PATH=/mnt/dhwfile/raise/user/linjuekai/Multimodel_Reasoning/training/rl/qwen35_4b_full_sft_spatial_general_gspo_compass/global_step_100/actor_hf_merged_sftmeta_rl_lmhead
BASE_ALIAS=qwen35_4b_spatial_general_rl_step100_sftmeta
...
echo "Submitted spatial/general step100 SFT-meta per-benchmark rollout jobs."
