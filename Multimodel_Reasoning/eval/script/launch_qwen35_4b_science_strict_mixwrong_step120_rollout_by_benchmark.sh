#!/bin/bash
# Roll out science strict mixwrong step120 on the four science benchmarks.
set -euo pipefail

PROJECT_DIR=/mnt/petrelfs/linjuekai/Multimodel_Reasoning/eval
MODEL_PATH=/mnt/dhwfile/raise/user/linjuekai/Multimodel_Reasoning/training/rl/qwen35_4b_full_sft_science_gspo_qwen_judge_strict_mixwrong_16k/global_step_120/actor/huggingface_vllm_fixed
BASE_ALIAS=qwen35_4b_science_strict_mixwrong_step120_fixed
...
echo "Submitted science strict mixwrong step120 per-benchmark rollout jobs."
