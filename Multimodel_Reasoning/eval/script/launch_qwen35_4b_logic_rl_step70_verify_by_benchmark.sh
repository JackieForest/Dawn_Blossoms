#!/bin/bash
# Split qwen35_4b_logic_rl_step70 rollout by benchmark, then verify each
# benchmark in an independent CompassVerifier job.
#
# Usage:
#   bash script/launch_qwen35_4b_logic_rl_step70_verify_by_benchmark.sh
#   bash script/launch_qwen35_4b_logic_rl_step70_verify_by_benchmark.sh VisuLogic
set -euo pipefail
...
SOURCE_ALIAS="${SOURCE_ALIAS:-qwen35_4b_logic_rl_step70_science_style}"
