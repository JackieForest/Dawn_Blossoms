#!/bin/bash
# Roll out spatial/general RL step100 on selected general/CV benchmarks.
set -euo pipefail

PROJECT_DIR=/mnt/petrelfs/linjuekai/Multimodel_Reasoning/eval
MODEL_PATH=/mnt/dhwfile/raise/user/linjuekai/Multimodel_Reasoning/training/rl/qwen35_4b_full_sft_spatial_general_gspo_compass/global_step_100/actor_hf_merged_science_style_rl_lmhead
BASE_ALIAS=qwen35_4b_spatial_general_rl_step100
...
echo "Submitted spatial/general step100 per-benchmark rollout jobs."
